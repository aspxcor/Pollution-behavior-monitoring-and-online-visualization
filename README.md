# 基于图像处理的排污行为监测、污水色度检测及在线可视化监测平台
...
近年来，为了提高水质检测的效率，人们对一些新技术进行了研发和运用，其中比较有代表性的是物联网技术和无人机技术。应用物联网技术，可对水环境的污染和治理情况进行监测，实现远程监控管理；利用无人机技术，可对目标水域进行监控，通过采集、传输监控图像到地面测控中心再进行分析，极大提高了水质样本的采集效率和应急环境的监测能力[9]。然而，这两种监测方式，仍然离不开人工的采集、检测和分析，如此才能获得相应的监测结果。注意到，随着视频监控等技术的成熟和硬件设备的成本降低，视频监控设备得到广泛的应用。因此，若能通过视频监控手段直接获取图像，并且对图像进行及时自动处理、分析得出判断结果，这将有助于提高水质检测的效率，为防止水质受到大范围的污染提供有效的监控手段。
